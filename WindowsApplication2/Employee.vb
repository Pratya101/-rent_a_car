...
Public Class EmployeeForm
    ...
    Private Sub LoadData()
        ...
        dgvDataEmloyee.Columns(0).Width = 120
        dgvDataEmloyee.Columns(1).Width = 120
        dgvDataEmloyee.Columns(2).Width = 125
        dgvDataEmloyee.Columns(3).Width = 100
        dgvDataEmloyee.Columns(4).Width = 125
        Conn.Close()
    End Sub
    Private Sub dgvData_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvDataEmloyee.CellEnter
        ...
        txtEPrass.Text = myDR.Item("empPassword")
